...
export default function ProductDetailsClient({ product: initialProduct, feedbackPercentage }) {
...
const handleTouchEnd = () => {
  ...
  const refreshProduct = async () => {
    try {
      ...
      console.log("dataaaa", listingsData);
    } catch (e) {
...
/>
          ...
          <div className="space-y-6 mt-5">
            ...
            {(product?.creator?.regions?.name ||
              product?.creator?.billing_address) && (
                <div
